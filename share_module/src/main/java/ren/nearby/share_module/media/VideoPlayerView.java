...
import ren.nearby.share_module.media.callback.MediaPlayerListener;
        ...
        public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                int message = framework_err == IMediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK ?
                        R.string.share_video_error_text_invalid_progressive_playback : R.string.share_video_error_text_unknown;

                new AlertDialog.Builder(mContext)
                        .setTitle(R.string.share_video_error_title)
                        .setMessage(message)
                        .setPositiveButton(
                                R.string.share_video_error_button,
                                (dialog, whichButton) -> {
